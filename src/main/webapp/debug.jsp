                                            ...
                                            List<Schedule> schedules = scheduleDao.findAll();
                                                ...
                                                <ul>
                                                    <% for (Subject s : subjects) { %>
                                                        <li>
                                                            <%= s.getCode() %> - <%= s.getName() %> (Lectures: <%=
                                                                        s.getLecturesPerWeek() %>, Practical: <%=
                                                                            s.isPractical() %>)
                                                        </li>
                                                        <% } %>
                                                </ul>
                                                ...
                                                <ul>
                                                    <% for (Workload w : workloads) { %>
                                                        <li>
                                                            <%= w.getFaculty().getName() %> teaches <%=
                                                                    w.getSubject().getName() %> to <%=
                                                ...
                                                <ul>
                                                    <% for (Schedule sch : schedules) { %>
                                                        <li>
                                                            <%= sch.getTimeSlot().getDayOfWeek() %>
                                                                <%= sch.getTimeSlot().getStartTime() %>:
                                                                    <%= sch.getWorkload().getSubject().getName() %>
                                                                        by <%= sch.getWorkload().getFaculty().getName()
                                                                            %>
                                                                            for <%=
                                                                                sch.getWorkload().getStudentGroup().getName()
                                                                                %>
                                                                                in <%= sch.getRoom().getName() %>
                                                        </li>
                                                        <% } %>
                                                </ul>
