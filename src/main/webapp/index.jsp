	...
	<body class="bg-background font-display text-text-main antialiased selection:bg-primary/20 selection:text-primary">
		<div class="relative flex min-h-screen w-full flex-col overflow-x-hidden">
			...
			<main class="flex-1">
								...
								<h1
									...
									Automate Your <span class="text-primary relative inline-block">
										College Scheduling <svg
											class="absolute w-full h-3 -bottom-1 left-0 text-primary/20" fill="none"
				...
				<section id="features" class="bg-white/50 py-20 border-y border-primary/5">
					<div class="mx-auto max-w-[1280px] px-6 md:px-20 lg:px-40">
						<div class="mb-16 flex flex-col items-center text-center">
							<h2 class="text-3xl font-bold tracking-tight text-primary-dark sm:text-4xl">Why
								Timetable Pro?</h2>
				...
				<section class="mx-auto max-w-[1280px] px-6 py-24 md:px-20 lg:px-40">
					<div
						...
						<div class="absolute right-0 top-0 -mr-20 -mt-20 size-64 rounded-full bg-white/10 blur-3xl">
						</div>
						<div class="absolute bottom-0 left-0 -ml-20 -mb-20 size-64 rounded-full bg-black/10 blur-3xl">
						</div>
						...
						<div class="relative z-10 flex flex-col items-center gap-8">
							<h2 class="max-w-2xl text-3xl font-bold tracking-tight sm:text-5xl">Ready
			...
			<footer class="border-t border-primary/10 bg-white/40 py-12">
				<div class="mx-auto max-w-[1280px] px-6 md:px-20 lg:px-40">
					<div class="flex flex-col items-center justify-between gap-8 md:flex-row">
						...
						<div class="flex flex-wrap justify-center gap-8 text-sm font-medium text-text-muted">
							<a class="hover:text-primary transition-colors" href="#">Privacy
								...
								of Service</a> <a class="hover:text-primary transition-colors" href="#">Help Center</a>
							<a class="hover:text-primary transition-colors" href="#">Contact</a>
						</div>
						<div class="flex items-center gap-4">
							<a class="text-text-muted hover:text-primary transition-colors hover:scale-110 transform"
